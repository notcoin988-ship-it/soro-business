...
Документы синтетические (см. factories.py): реальных PDF банка от тимлида
не дождались. Содержимое подобрано под настоящий кейс — таджикский с
диакритикой, проценты, суммы, таблицы курсов.
